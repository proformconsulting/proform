          ...
          <div className="grid lg:grid-cols-[1.1fr,0.9fr] gap-10 items-start">
            ...
            <div>
              ...
              <p className="text-[#4b5563] text-sm md:text-base mb-6 max-w-2xl">
                Cieľom je dať vám{" "}
                <strong>rýchly a férový odhad</strong> nákladov. Čísla sú
                ...
                {mode === "build" && (
                  <div className="border-t border-[#e2e8f0] pt-4 space-y-2">
                    ...
                    <p className="text-[11px] text-[#9ca3af]">
                      VR je súčasťou nášho servisného balíka – suma sa pripočíta
                      k položke „Projekt + riadenie stavby“.
                    </p>
                  </div>
                )}

                <p className="text-[11px] text-[#9ca3af]">
                  Ide o informatívny výpočet. Skutočná cena závisí od pozemku,
                  materiálov, technológií a detailného zadania. Po krátkom
                  telefonáte vám pripravíme presnejšiu ponuku.
                </p>
              </div>
            </div>

            {/* pravá strana – výsledok + info box */}
