...
export default function CookieHu() {
  return (
    <main className="min-h-screen bg-[#f5f7fb] relative overflow-hidden text-slate-900">
      ...
      <section className="pt-28 md:pt-32 pb-12 text-center relative z-10 px-4">
        ...
        <p className="max-w-2xl mx-auto mt-4 text-[#475569] text-sm md:text-lg leading-relaxed">
          Rövid összefoglaló a sütik használatáról.
        </p>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-4 md:px-6 pb-24">
        <div className="bg-white/95 rounded-2xl border border-[#d4ddee] shadow-[0_15px_45px_rgba(145,163,185,0.28)] p-7 md:p-10 space-y-5">
          <div className="rounded-2xl border border-[#e6eefc] bg-[#f8fbff] p-6">
            <h2 className="text-base font-semibold text-[#1e3a8a]">Mit használunk?</h2>
            <p className="mt-2 text-sm text-[#475569] leading-relaxed">
              Az oldal alapvető működéséhez szükséges technikai cookie-kat használhat (pl. nyelv / navigáció / biztonság).
            </p>
          </div>

          <div className="rounded-2xl border border-[#eef2ff] bg-white p-6">
            <h2 className="text-base font-semibold text-[#1e3a8a]">Marketing cookie-k</h2>
            <p className="mt-2 text-sm text-[#475569]">
              Jelenleg nem alkalmazunk célzott marketing / követő cookie-kat. Amennyiben ez változik, a tájékoztatót frissítjük.
            </p>
          </div>

          <div className="rounded-2xl border border-[#eef2ff] bg-white p-6">
            <h2 className="text-base font-semibold text-[#1e3a8a]">Beállítások</h2>
            <p className="mt-2 text-sm text-[#475569]">
              A sütik a böngésző beállításaiban korlátozhatók vagy törölhetők.
            </p>
          </div>

          <p className="text-[11px] text-[#94a3b8]">
            Megjegyzés: ha később Google Analytics / Meta Pixel kerül be, cookie banner és részletes kategóriák javasoltak.
          </p>
        </div>
      </section>
    </main>
